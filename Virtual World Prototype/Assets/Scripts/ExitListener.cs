...
namespace Hover{
	...
	**Class: ExitListener
	**Version: 1.0
	**Description:Creates and handles the listeners for the Exit option (Selector Item), to be used for the Hovercast menu. 
	...
	**/
	public class ExitListener : BaseListener<ISelectorItem> {
